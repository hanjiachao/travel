...
;(function () {
  ...
  function Brush () {
    ...
    var keywords =	'-Infinity ...rest Array as AS3 Boolean break case catch const continue Date decodeURI ' +
                ...
                'return set staticPage String super switch this throw true try typeof uint undefined unescape ' +
                'use void while with'
...
;(function () {
  ...
  function Brush () {
    ...
    this.regexList = [
      ...
      { regex: new RegExp(this.getKeywords(operators), 'gmi'),	css: 'color1' }, // operator and such
...
;(function () {
  ...
  function Brush () {
    ...
    var keywords =	'auto break case catch class const decltype __finally __exception __try ' +
						...
						'sizeof staticPage static_cast struct switch template this ' +
...
;(function () {
  ...
  function Brush () {
    var keywords =	'abstract as base bool break byte case catch char checked class const ' +
						...
						'short sizeof stackalloc staticPage string struct switch this throw true try ' +
...
;(function () {
  ...
  function Brush () {
    ...
    var values =	'above absolute all always aqua armenian attr aural auto avoid baseline behind below bidi-override black blink block blue bold bolder ' +
						...
						'small small-caps small-caption smaller soft solid speech spell-out square s-resize staticPage status-bar sub super sw-resize ' +
...
;(function () {
  ...
  function Brush () {
    ...
    var keywords =	'as assert break case catch class continue def default do else extends finally ' +
						...
						'throw throws try while public protected private staticPage'
...
;(function () {
  ...
  function Brush () {
    var keywords =	'abstract assert boolean break byte case catch char class const ' +
						...
						'short staticPage strictfp super switch synchronized this throw throws true ' +
...
;(function () {
  ...
  function Brush () {
    ...
    var keywords = 'abstract after and as assert at before bind bound break catch class ' +
						...
						'attribute let private readonly staticPage trigger'
...
;(function () {
  ...
  function Brush () {
    ...
    this.regexList = [
      ...
      // is this too much?
      { regex: /\bq[qwxr]?\([\s\S]*?\)/g,	css: 'string' }, // quote-like operator ()
      { regex: /\bq[qwxr]?\{[\s\S]*?\}/g,	css: 'string' }, // quote-like operator {}
      { regex: /\bq[qwxr]?\[[\s\S]*?\]/g,	css: 'string' }, // quote-like operator []
      { regex: /\bq[qwxr]?(<|&lt;)[\s\S]*?(>|&gt;)/g,	css: 'string' }, // quote-like operator <>
      { regex: /\bq[qwxr]?([^\w({<[])[\s\S]*?\1/g,	css: 'string' }, // quote-like operator non-paired
...
;(function () {
  ...
  function Brush () {
    ...
    var keywords =	'abstract and array as break case catch cfunction class clone const continue declare default die do ' +
						...
						'old_function or private protected public return require require_once staticPage switch ' +
...
;(function () {
  ...
  function Brush () {
    ...
    this.regexList = [
      ...
      { regex: new RegExp('-' + this.getKeywords(operators), 'gmi'),									css: 'operator value' },				// operator
...
;(function () {
  ...
  function Brush () {
    ...
    var keywords =	'absolute action add after alter as asc at authorization begin bigint ' +
						...
						'second section select sequence serializable set size smallint staticPage ' +
