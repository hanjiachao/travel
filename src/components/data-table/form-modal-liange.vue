...
<template>
  <div class="test">
    ...
    <Modal v-model="modalShow" :title="title" :mask-closable="false" class="form-modal">
      <data-form :config="config" ref="dataForm" :sending="sending" :formItems="formItems" :defaultData="defaultData" v-if="formItemLength <= 5 && formItemLength > 0"></data-form>
