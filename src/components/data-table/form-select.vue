<template>
  <el-select :disabled="disabled" v-model="option" :size="configObj.size || 'large'" :clearable="configObj.clearable" @on-change="giveValue" :placeholder="placeholder">
    <el-option v-for="(option, index) in options" :value="option.value" :key="index">
      {{ option.label }}
    </el-option>
  </el-select>
</template>
