      ...
      <transition name="el-zoom-in-top">
        <div v-show="hidePartShow" class="hide-part">
          <div class="search-box" v-if="configObj.searchAllow">
            <!--<div class="fr">-->
              <!--<Icon style="cursor: pointer; vertical-align: middle;" size="24" type="ios-search" @click="searchList" />-->
            <!--</div>-->
...
export default {
  ...
  mounted () {
    // let selectPaging = document.getElementById('select-paging-ry')
    // let _this = this
    // this.clickMethod = function (e) {
    //   if (!selectPaging.contains(e.target)) {
    //     _this.hidePartShow = false
    //   }
    // }
    // window.addEventListener('click', this.clickMethod)
  },
  beforeDestroy () {
    // window.removeEventListener('click', this.clickMethod)
  },
  watch: {
    value: {
      handler (value) {
