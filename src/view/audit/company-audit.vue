...
export default {
  ...
  data () {
    return {
      means: means,
      powerList: ['audit_alteration_company', 'audit_alteration_company', 'audit_delete_record_company', 'audit_shift_out_record_company', 'audit_shift_in_record_company'],
      tabList: [{
        title: '公司/单位添加审核',
        auth: 'audit_alteration_company',
        showTable: false,
        config: {
          url: 'company/alterations',
          primaryKey: 'id',
          hasType: true,
          extraData: [{
            value: '创建',
        ...
        auditInfo: {
          auth: 'audit_alteration_company_btn',
          url: 'company/audit_alteration',
          title: '公司/单位添加审核'
        },
        history: {
        ...
        title: '公司/单位删除审核',
        auth: 'audit_delete_record_company',
        showTable: false,
        config: {
          url: 'company/delete_records',
          primaryKey: 'id',
        ...
        auditInfo: {
          auth: 'audit_delete_record_company_btn',
          url: 'company/audit_delete_record',
          title: '公司/单位删除审核'
        },
        history: {
        ...
        title: '公司/单位转出审核',
        auth: 'audit_shift_out_record_company',
        showTable: false,
        config: {
          url: 'company/shift_out_records',
          primaryKey: 'id',
          namePosition: 'company.name',
          hasType: true,
          dataPosition: ['result', 'list']
        ...
        auditInfo: {
          auth: 'audit_shift_out_record_company_btn',
          url: 'company/audit_shift_out_record',
          title: '公司/单位转出审核',
        ...
        title: '公司/单位转入审核',
        auth: 'audit_shift_in_record_company',
        showTable: false,
        config: {
          url: 'company/shift_in_records',
          primaryKey: 'id',
          namePosition: 'company.name',
          hasType: true,
          dataPosition: ['result', 'list']
        ...
        auditInfo: {
          auth: 'audit_shift_in_record_company_btn',
          url: 'company/audit_shift_in_record',
          title: '公司/单位转入审核',
        ...
        hideItem: {
          ...
          itemList: [{
            ...
            formItems: [{
              ...
              value: 'created_organization_detail.name',
              label: '申请人所属工会'
            }, {
              value: 'created_organization_detail.mobile',
              label: '所属工会联系方式'
            }, {
              value: 'operate_type',
              label: '变更类型'
