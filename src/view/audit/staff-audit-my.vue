...
export default {
  ...
  data () {
    return {
      means: means,
      powerList: ['alteration_staff_my', 'alteration_staff_my', 'delete_record_staff_my', 'shift_record_staff_my'],
      tabList: [{
        title: '职工会员添加申请',
        auth: 'alteration_staff_my',
        showTable: false,
        config: {
          url: 'staff/my_alterations',
          primaryKey: 'id',
          hasType: true,
          extraData: [{
            value: '创建',
        ...
        title: '职工会员删除申请',
        auth: 'delete_record_staff_my',
        showTable: false,
        config: {
          url: 'staff/my_delete_records',
          primaryKey: 'id',
        ...
        title: '职工会员转移申请',
        auth: 'shift_record_staff_my',
        showTable: false,
        config: {
          url: 'staff/my_shift_records',
          primaryKey: 'id',
          namePosition: 'staff.name',
          hasType: true,
          dataPosition: ['result', 'list']
