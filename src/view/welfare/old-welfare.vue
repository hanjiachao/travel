          ...
          <Col class="welfare-item" :xs="24"  :sm="12" :md="12" :lg="8" v-for="(ticket, ticketIndex) in ticketList" :key="ticketIndex">
            <div class="welfare-father">
              ...
              <div class="top-half">
                ...
                <div class="fr" style="width: 80px; padding-top: 10px;">
                  <ul>
                    ...
                    <li class="fl operation-item" v-if="means.hasPermission('edit_ticket') && ticket.is_new">
                      <el-tooltip content="编辑" placement="top">
                        <Icon size="20" style="cursor: pointer" type="ios-brush" :color="'rgb(' + ticket.theme_color + ')'" @click="edit(ticket)"/>
                      </el-tooltip>
                    </li>
                    <li class="fl operation-item" v-if="means.hasPermission('change_status_ticket') && ticket.is_new">
                      <Poptip
                        transfer
                        confirm
                        title="确认要启用吗?"
  ...
  methods: {
    ...
    getTicketList () {
      ...
      ajax.get({
        ...
        _this.ticketList = res.result.list
        _this.pageData = {
